...
use synapseclaw::providers::compatible::AuthStyle;
use synapseclaw::providers::traits::{ChatMessage, ChatResponse, ToolCall};
...
fn provider_construction_with_different_names() {
    use synapseclaw::providers::compatible::OpenAiCompatibleProvider;
