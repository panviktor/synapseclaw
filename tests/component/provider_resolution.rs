...
use synapseclaw::providers::compatible::{AuthStyle, OpenAiCompatibleProvider};
use synapseclaw::providers::{
...
fn factory_resolves_openai_codex_provider() {
    let options = synapseclaw::providers::ProviderRuntimeOptions::default();
