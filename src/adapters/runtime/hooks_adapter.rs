...
pub struct HookRunnerAdapter {
    runner: Arc<crate::adapters::hooks::HookRunner>,
}

impl HookRunnerAdapter {
    pub fn new(runner: Arc<crate::adapters::hooks::HookRunner>) -> Self {
        Self { runner }
    }
}
...
impl HooksPort for HookRunnerAdapter {
    async fn on_message_received(
        ...
        let msg = crate::adapters::channels::traits::ChannelMessage {
        ...
        match self.runner.run_on_message_received(msg).await {
            crate::adapters::hooks::HookResult::Continue(modified_msg) => {
                HookOutcome::Continue(modified_msg.content)
            }
            crate::adapters::hooks::HookResult::Cancel(reason) => HookOutcome::Cancel(reason),
        }
    }
    ...
    async fn on_message_sending(
        ...
        match self
            ...
            .await
        {
            crate::adapters::hooks::HookResult::Continue((_ch, _rcpt, modified_content)) => {
