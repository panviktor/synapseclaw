...
use crate::adapters::channels::session_backend::{ChannelSummary, SessionBackend};
use std::sync::Arc;
use synapse_core::ports::session_summary::SessionSummaryPort;

pub struct SessionStoreAdapter {
    store: Arc<crate::adapters::channels::session_store::SessionStore>,
}

impl SessionStoreAdapter {
    pub fn new(store: Arc<crate::adapters::channels::session_store::SessionStore>) -> Self {
        Self { store }
    }
}
