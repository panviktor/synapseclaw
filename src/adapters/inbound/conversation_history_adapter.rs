...
//! The port trait expects `synapse_core::domain::message::ChatMessage`.
//! Conversions happen at the trait boundary using helpers from `fork_adapters`.

use crate::adapters::channels::session_store::SessionStore;
...
use synapse_core::ports::conversation_history::ConversationHistoryPort;
