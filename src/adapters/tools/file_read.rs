...
mod tests {
    ...
    async fn e2e_agent_file_read_pdf_extraction() {
        use crate::adapters::providers::{ChatResponse, Provider, ToolCall};
    ...
    async fn e2e_live_file_read_pdf() {
        use crate::adapters::providers::openai_codex::OpenAiCodexProvider;
        use crate::adapters::providers::{Provider, ProviderRuntimeOptions};
        use crate::agent::agent::Agent;
