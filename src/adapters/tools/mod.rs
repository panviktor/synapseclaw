...
//! [`SecurityPolicy`](synapse_core::domain::security_policy::SecurityPolicy) at construction time.
//!
//! # Extension
//!
...
use crate::adapters::runtime::native::NativeRuntime;
...
#[async_trait]
impl synapse_core::ports::agent_runner::AgentRunnerPort for NoopAgentRunner {
    async fn run(
        &self,
        ...
        _run_ctx: Option<Arc<synapse_core::domain::tool_audit::RunContext>>,
...
pub fn all_tools_with_runtime(
    ...
    let provider_runtime_options = crate::adapters::providers::ProviderRuntimeOptions {
