...
pub(crate) fn to_core_message(
    msg: &crate::adapters::providers::ChatMessage,
) -> synapse_core::domain::message::ChatMessage {
    synapse_core::domain::message::ChatMessage {
        role: msg.role.clone(),
...
pub(crate) fn from_core_message(
    msg: &synapse_core::domain::message::ChatMessage,
...
) -> synapse_core::domain::channel::InboundEnvelope {
    use synapse_core::domain::channel::{InboundEnvelope, SourceKind};
    InboundEnvelope {
