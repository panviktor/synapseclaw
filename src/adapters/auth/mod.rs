...
use crate::adapters::auth::openai_oauth::refresh_access_token;
use crate::adapters::auth::profiles::{
...
impl AuthService {
    ...
    pub async fn store_openai_tokens(
        &self,
        profile_name: &str,
        token_set: crate::adapters::auth::profiles::TokenSet,
...
mod tests {
    use super::*;
    use crate::adapters::auth::profiles::{AuthProfile, AuthProfileKind};
