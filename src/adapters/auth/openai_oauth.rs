use crate::adapters::auth::oauth_common::{parse_query_params, url_encode};

use crate::adapters::auth::profiles::TokenSet;
...
pub use crate::adapters::auth::oauth_common::{generate_pkce_state, PkceState};
...
pub async fn receive_loopback_code(expected_state: &str, timeout: Duration) -> Result<String> {
    ...
    let body =
        "<html><body><h2>SynapseClaw login complete</h2><p>You can close this tab.</p></body></html>";
    let response = format!(
