...
use crate::adapters::multimodal;
use crate::adapters::providers::traits::{
...
impl OpenAiCompatibleProvider {
    ...
    fn tool_specs_to_openai_format(
        tools: &[crate::adapters::tools::ToolSpec],
...
impl OpenAiCompatibleProvider {
    ...
    fn convert_tool_specs(
        tools: Option<&[crate::adapters::tools::ToolSpec]>,
    ...
    fn with_prompt_guided_tool_instructions(
        ...
        let instructions = crate::adapters::providers::traits::build_tool_instructions_text(tools);
...
impl Provider for OpenAiCompatibleProvider {
    fn capabilities(&self) -> crate::adapters::providers::traits::ProviderCapabilities {
        crate::adapters::providers::traits::ProviderCapabilities {
...
mod tests {
    ...
    fn prompt_guided_tool_fallback_injects_system_instruction() {
        ...
        let tools = vec![crate::adapters::tools::ToolSpec {
    ...
    fn tool_specs_convert_to_openai_format() {
        let specs = vec![crate::adapters::tools::ToolSpec {
