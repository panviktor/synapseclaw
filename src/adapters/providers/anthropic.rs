...
use crate::adapters::tools::ToolSpec;
        ...
        for msg in messages {
            match msg.role.as_str() {
                ...
                _ => {
                    ...
                    let (text, image_refs) =
                        crate::adapters::multimodal::parse_image_markers(&msg.content);
...
mod tests {
    use super::*;
    use crate::adapters::auth::anthropic_token::{detect_auth_kind, AnthropicAuthKind};
