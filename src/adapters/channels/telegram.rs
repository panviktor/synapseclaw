...
mod tests {
    ...
    async fn e2e_live_voice_transcription_and_reply_cache() {
        ...
        let transcript: String = crate::adapters::channels::transcription::transcribe_audio(
            audio_data,
            "hello.mp3",
            &config,
        )
    ...
    fn markdown_attachment_not_detected_by_multimodal_image_markers() {
        ...
        let messages = vec![crate::adapters::providers::ChatMessage::user(content)];
        assert_eq!(
            crate::adapters::multimodal::count_image_markers(&messages),
            0,
    ...
    fn photo_image_marker_detected_by_multimodal() {
        ...
        let messages = vec![crate::adapters::providers::ChatMessage::user(
            photo_content.to_string(),
        )];
        let count = crate::adapters::multimodal::count_image_markers(&messages);
        assert_eq!(
            count, 1,
    ...
    fn e2e_attachment_saves_file_and_formats_content() {
        ...
        let doc_msgs = vec![crate::adapters::providers::ChatMessage::user(doc_content)];
        assert_eq!(
            crate::adapters::multimodal::count_image_markers(&doc_msgs),
            0,
        ...
        let photo_msgs = vec![crate::adapters::providers::ChatMessage::user(
            photo_content.clone(),
        )];
        assert_eq!(
            crate::adapters::multimodal::count_image_markers(&photo_msgs),
            1,
        ...
        let cap_msgs = vec![crate::adapters::providers::ChatMessage::user(
            captioned.clone(),
        )];
        assert_eq!(
            crate::adapters::multimodal::count_image_markers(&cap_msgs),
            1,
        ...
        let md_msgs = vec![crate::adapters::providers::ChatMessage::user(md_content)];
        assert_eq!(
            crate::adapters::multimodal::count_image_markers(&md_msgs),
            0,
            "markdown file must not trigger image marker detection"
        );
    }
    ...
    fn groq_provider_rejects_photo_with_vision_error() {
        use crate::adapters::providers::compatible::{AuthStyle, OpenAiCompatibleProvider};
        ...
        let marker_count = crate::adapters::multimodal::count_image_markers(&messages);
