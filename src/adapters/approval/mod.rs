...
impl ApprovalManager {
    ...
    pub fn needs_approval(&self, tool_name: &str) -> bool {
        ...
        synapse_core::application::services::approval_service::check_needs_approval(
            tool_name,
            self.autonomy_level,
            &auto_approve,
            &always_ask,
    ...
    pub fn record_decision(
        ...
        use synapse_core::application::services::approval_service;
        use synapse_core::domain::approval::ApprovalResponse as DomainResponse;
...
impl synapse_core::ports::approval::ApprovalPort for ApprovalManager {
    ...
    async fn request_approval(
        ...
        tool_name: &str,
        arguments: &str,
    ) -> anyhow::Result<synapse_core::domain::approval::ApprovalResponse> {
        if self.non_interactive {
            return Ok(synapse_core::domain::approval::ApprovalResponse::No);
        }
        ...
        Ok(match cli_response {
            ApprovalResponse::Yes => synapse_core::domain::approval::ApprovalResponse::Yes,
            ApprovalResponse::No => synapse_core::domain::approval::ApprovalResponse::No,
            ApprovalResponse::Always => synapse_core::domain::approval::ApprovalResponse::Always,
        })
    }

    fn record_decision(&self, decision: &synapse_core::domain::approval::ApprovalDecision) {
        let cli_response = match decision.response {
            synapse_core::domain::approval::ApprovalResponse::Yes => ApprovalResponse::Yes,
            synapse_core::domain::approval::ApprovalResponse::No => ApprovalResponse::No,
            synapse_core::domain::approval::ApprovalResponse::Always => ApprovalResponse::Always,
        };
