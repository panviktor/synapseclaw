...
use crate::fork_core::application::services::conversation_service;
...
pub struct ConversationRunResult {
    ...
    pub state: crate::fork_core::domain::run::RunState,
}
...
mod tests {
    use super::*;
    use crate::fork_core::domain::conversation::ConversationSession;
    use crate::fork_core::domain::run::{Run, RunState};
    ...
    impl ConversationStorePort for MockConversationStore {
        ...
        async fn append_event(&self, _key: &str, _event: &crate::fork_core::domain::conversation::ConversationEvent) -> Result<()> { Ok(()) }
        async fn get_events(&self, _key: &str, _limit: usize) -> Vec<crate::fork_core::domain::conversation::ConversationEvent> { vec![] }
    ...
    impl RunStorePort for MockRunStore {
        ...
        async fn append_event(&self, _event: &crate::fork_core::domain::run::RunEvent) -> anyhow::Result<()> {
            Ok(())
        }
        async fn get_events(&self, _run_id: &str, _limit: usize) -> Vec<crate::fork_core::domain::run::RunEvent> {
            vec![]
        }
    }
