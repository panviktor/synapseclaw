...
pub async fn handle_api_cli_tools(
    ...
    let tools = crate::fork_adapters::tools::cli_discovery::discover_cli_tools(&[], &[]);
...
pub async fn handle_api_activity(
    ...
    use crate::fork_adapters::gateway::ipc::{ActivityEvent, TraceRef};
...
mod tests {
    ...
    fn masking_keeps_toml_valid_and_preserves_api_keys_type() {
        ...
        cfg.channels_config.email =
            Some(crate::fork_adapters::channels::email_channel::EmailConfig {
