...
mod tests {
    ...
    use crate::fork_adapters::gateway::ipc::{
    ...
    use crate::fork_adapters::gateway::AppState;
    ...
    struct TestProvider;
    #[async_trait]
    impl crate::fork_adapters::providers::traits::Provider for TestProvider {
    ...
    fn test_app_state(db: Arc<IpcDb>, token_hash: &str) -> AppState {
        ...
        AppState {
            ...
            rate_limiter: std::sync::Arc::new(
                crate::fork_adapters::gateway::GatewayRateLimiter::new(100, 100, 100),
            ),
            idempotency_store: std::sync::Arc::new(
                crate::fork_adapters::gateway::IdempotencyStore::new(
            ...
            node_registry: std::sync::Arc::new(
                crate::fork_adapters::gateway::nodes::NodeRegistry::new(16),
            ),
