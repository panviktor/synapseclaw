use crate::fork_adapters::channels::traits::{Channel, ChannelMessage, SendMessage};
...
/// and forwards PRIVMSG messages to the `SynapseClaw` message bus.
...
impl Channel for IrcChannel {
    ...
    async fn listen(&self, tx: mpsc::Sender<ChannelMessage>) -> anyhow::Result<()> {
        ...
        Self::send_raw(
            &mut writer,
            &format!("USER {} 0 * :SynapseClaw", self.username),
        )
        .await?;
...
mod tests {
    ...
    fn new_stores_all_fields() {
        let ch = IrcChannel::new(IrcChannelConfig {
            ...
            port: 6697,
            nickname: "zcbot".into(),
            username: Some("synapseclaw".into()),
        ...
        assert_eq!(ch.username, "synapseclaw");
    ...
    fn irc_config_serde_roundtrip() {
        use fork_config::schema::IrcConfig;
        ...
        assert_eq!(parsed.username.as_deref(), Some("synapseclaw"));
