...
//! sketch code and calls this tool. SynapseClaw compiles and uploads it — no
...
impl Tool for ArduinoUploadTool {
    ...
    async fn execute(&self, args: Value) -> anyhow::Result<ToolResult> {
        ...
        let sketch_name = "synapseclaw_sketch";
        let temp_dir = std::env::temp_dir().join(format!("synapseclaw_{}", uuid::Uuid::new_v4()));
