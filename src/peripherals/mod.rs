...
/// Handle `synapseclaw peripheral` subcommands.
    ...
    match cmd {
        crate::PeripheralCommands::List => {
            ...
            if boards.is_empty() {
                ...
                println!();
                println!("Add one with: synapseclaw peripheral add <board> <path>");
                println!("  Example: synapseclaw peripheral add nucleo-f401re /dev/ttyACM0");
                println!();
