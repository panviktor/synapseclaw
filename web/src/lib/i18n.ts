...
const translations: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    // Subtitles
    'dashboard.subtitle': '系统概览和健康状态',
    'agent.subtitle': '与你的 AI 智能体对话',
    'tools.subtitle': '可用工具及其参数',
    ...
    'logs.subtitle': '实时事件流',
    'doctor.subtitle': '运行系统诊断',
    'ipc.fleet_subtitle': '监控全部智能体',
    'ipc.activity_subtitle': '智能体间消息动态',
    'ipc.sessions_subtitle': '查看活跃会话',
    'ipc.spawns_subtitle': '追踪衍生子智能体',
    ...
    'doctor.empty_hint': '点击"运行诊断"检查您的 SynapseClaw 安装。',
  ...
  en: {
    ...
    // Subtitles
    'dashboard.subtitle': 'System overview and health status',
    'agent.subtitle': 'Chat with your AI agent',
    'tools.subtitle': 'Available tools and their parameters',
    ...
    'doctor.subtitle': 'Run system diagnostics',
    'ipc.fleet_subtitle': 'Monitor all agents in the fleet',
    'ipc.activity_subtitle': 'Inter-agent message feed',
    'ipc.sessions_subtitle': 'Inspect active sessions',
    'ipc.spawns_subtitle': 'Track spawned sub-agents',
    ...
    'doctor.empty_hint': 'Click "Run Diagnostics" to check your SynapseClaw installation.',
    ...
    'nav.ipc_audit': 'Audit',
    'nav.ipc_activity': 'Activity',
    'nav.ipc_cron': 'Fleet Cron',
  ...
  tr: {
    ...
    // Subtitles
    'dashboard.subtitle': 'Sistem genel bakışı ve sağlık durumu',
    'agent.subtitle': 'AI ajanınızla sohbet edin',
    'tools.subtitle': 'Mevcut araçlar ve parametreleri',
    ...
    'doctor.subtitle': 'Sistem tanılarını çalıştırın',
    'ipc.fleet_subtitle': 'Filodaki tüm ajanları izleyin',
    'ipc.activity_subtitle': 'Ajanlar arası mesaj akışı',
    'ipc.sessions_subtitle': 'Aktif oturumları inceleyin',
    'ipc.spawns_subtitle': 'Oluşturulan alt ajanları takip edin',
    ...
    'doctor.empty_hint': 'SynapseClaw kurulumunuzu kontrol etmek için "Tanı Çalıştır" düğmesine tıklayın.',
    ...
    'nav.ipc_activity': 'Etkinlik',
    'nav.ipc_cron': 'Filo Cron',
