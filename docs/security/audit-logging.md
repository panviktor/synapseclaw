...
## Problem
SynapseClaw logs actions but lacks tamper-evident audit trails for:
...
# Tamper evidence
sign_events = true
signing_key_path = "~/.config/synapseclaw/audit.key"
...
synapseclaw audit --user @alice

# Show all high-risk commands
synapseclaw audit --risk high

# Show violations from last 24 hours
synapseclaw audit --since 24h --violations-only

# Export to JSON for analysis
synapseclaw audit --format json --output audit.json
