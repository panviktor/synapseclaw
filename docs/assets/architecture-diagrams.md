# SynapseClaw Architecture Diagrams

This document provides visual representations of SynapseClaw's architecture, execution modes, and data flows.

---

## 1. Execution Modes

**Ways SynapseClaw can be run:**

```mermaid
flowchart TD
    Start[synapseclaw CLI] --> Onboard[onboard<br/>Setup wizard]
...
```mermaid
flowchart TB
    Start[[synapseclaw daemon]] --> SpawnComponents
...
```mermaid
flowchart TB
    Client[HTTP Client] --> Gateway[SynapseClaw Gateway]
...
flowchart TB
    ...
    Defaults --> EnvOverrides[apply_env_overrides<br/>SYNAPSECLAW_* env vars]
...
*Generated for SynapseClaw v0.1.0 - Architecture Documentation*
