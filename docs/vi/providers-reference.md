# Tài liệu tham khảo Providers — SynapseClaw
...
3. Biến môi trường dự phòng chung: `SYNAPSECLAW_API_KEY`, sau đó là `API_KEY`
...
- Sau khi chuẩn hóa multimodal, SynapseClaw gửi payload hình ảnh qua trường `messages[].images` gốc của Ollama.
- Nếu chọn provider không hỗ trợ vision, SynapseClaw trả về lỗi rõ ràng thay vì âm thầm bỏ qua hình ảnh.
...
- Khám phá model: `synapseclaw models refresh --provider nvidia`
