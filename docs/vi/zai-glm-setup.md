...
SynapseClaw hỗ trợ các model GLM của Z.AI thông qua các endpoint tương thích OpenAI.
Hướng dẫn cấu hình thực tế theo provider hiện tại của SynapseClaw.

## Tổng quan

SynapseClaw hỗ trợ sẵn các alias và endpoint Z.AI sau đây:
...
### Kiểm tra bằng SynapseClaw CLI

```bash
# Test agent directly
echo "Hello" | synapseclaw agent
