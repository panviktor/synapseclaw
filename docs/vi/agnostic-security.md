...
|---------|-----------|--------------|--------|
| **SynapseClaw cơ bản** | 3.4MB | <5MB | ✅ Hiện tại |
...
| Phần cứng | RAM | SynapseClaw (cơ bản) | SynapseClaw (full security) | Trạng thái |
|----------|-----|-----------------|--------------------------|--------|
...
**Ngay cả với full security, SynapseClaw chỉ dùng <5% RAM trên board $10.**

---

## 5. Tính hoán đổi: mọi thứ vẫn pluggable

### Cam kết chính của SynapseClaw: hoán đổi bất kỳ thứ gì
