...
Cách cài đặt và khởi tạo SynapseClaw nhanh nhất.
...
Mặc định là **chỉ ứng dụng** (build/cài SynapseClaw), yêu cầu Rust toolchain sẵn có.
...
Lệnh này build image SynapseClaw cục bộ và chạy thiết lập trong container, lưu config/workspace vào `./.synapseclaw-docker`.
