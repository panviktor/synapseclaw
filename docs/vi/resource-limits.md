...
## Vấn đề
SynapseClaw có rate limiting (20 actions/hour) nhưng chưa có giới hạn tài nguyên. Một agent bị lỗi lặp vòng có thể:
...
Tự động tạo cgroup cho synapseclaw với các giới hạn.
