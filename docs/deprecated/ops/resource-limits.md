# Resource Limits for SynapseClaw
...
## Problem
SynapseClaw has rate limiting (20 actions/hour) but no resource caps. A runaway agent could:
...
Automatically create a cgroup for synapseclaw with limits.
