# SynapseClaw PR Workflow (High-Volume Collaboration)

This document defines how SynapseClaw handles high PR volume while maintaining:
...
- If identity-like wording appears in tests/examples, it is normalized to SynapseClaw/project-native labels.
...
- Confirm any required identity-like wording uses SynapseClaw/project-native terminology.
