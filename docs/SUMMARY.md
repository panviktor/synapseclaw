...
- [Mental model](use/skills/mental-model.md)
- [Concepts](use/skills/concepts.md)
- [Methods](use/skills/methods.md)
- [Create a user skill](use/skills/create-user-skill.md)
- [Authoring patterns](use/skills/authoring-patterns.md)
- [On-demand loading](use/skills/on-demand-loading.md)
- [Why skills work this way](use/skills/why-skills-work-this-way.md)
- [Safety and governance](use/skills/safety-and-governance.md)
