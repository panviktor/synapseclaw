...
SynapseClaw 通过兼容 OpenAI 的端点支持 Z.AI 的 GLM 模型。
本指南介绍与当前 SynapseClaw 提供商行为匹配的实用安装选项。

## 概述

SynapseClaw 开箱即用支持以下 Z.AI 别名和端点：
...
- [SynapseClaw 说明文档](../../../README.zh-CN.md)
