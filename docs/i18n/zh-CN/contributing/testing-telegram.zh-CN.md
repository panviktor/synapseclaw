...
| 二进制大小 | ~3-4MB | `ls -lh target/release/synapseclaw` |
| 健康检查 | <5s | `time synapseclaw channel doctor` |
| 首次响应 | <3s | Telegram 中手动测试 |
| 消息拆分 | <50ms | 检查调试日志 |
| 内存使用 | <10MB | `ps aux \| grep synapseclaw` |
...
- Issue：<https://github.com/panviktor/synapseclaw/issues>
