# SynapseClaw Contributor License Agreement (CLA)
...
property rights granted by contributors to SynapseClaw Labs. This agreement
protects both contributors and users of the SynapseClaw project.

By submitting a contribution (pull request, patch, issue with code, or any
other form of code submission) to the SynapseClaw repository, you agree to the
terms of this CLA.
...
- **"Contribution"** means any original work of authorship, including any
  modifications or additions to existing work, submitted to SynapseClaw Labs
  for inclusion in the SynapseClaw project.

- **"You"** means the individual or legal entity submitting a Contribution.

- **"SynapseClaw Labs"** means the maintainers and organization responsible
  for the SynapseClaw project at https://github.com/panviktor/synapseclaw.

---

## 2. Grant of Copyright License

You grant SynapseClaw Labs and recipients of software distributed by SynapseClaw
...
the SynapseClaw project.

**This protects you:** if a third party files a patent claim against
SynapseClaw that covers your Contribution, your patent license to the project
is not revoked.
...
This CLA does **not** transfer ownership of your Contribution to SynapseClaw
...
3. If your employer has rights to intellectual property you create, you
   ...
   has signed a corporate CLA with SynapseClaw Labs.

---

## 6. No Trademark Rights

This CLA does not grant you any rights to use the SynapseClaw name,
...
SynapseClaw Labs will maintain attribution to contributors in the repository
...
All Contributions accepted into the SynapseClaw project are licensed under
both:
...
By opening a pull request or submitting a patch to the SynapseClaw repository,
...
https://github.com/panviktor/synapseclaw/issues

---

*This CLA is based on the Apache Individual Contributor License Agreement
v2.0, adapted for the SynapseClaw dual-license model.*
