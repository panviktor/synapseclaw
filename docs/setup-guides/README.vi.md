...
| Tình huống | Lệnh |
|----------|---------|
| Có API key, muốn cài nhanh nhất | `synapseclaw onboard --api-key sk-... --provider openrouter` |
| Muốn được hướng dẫn từng bước | `synapseclaw onboard` |
| Đã có config, chỉ cần sửa kênh | `synapseclaw onboard --channels-only` |
...
- Thiết lập nhanh: `synapseclaw onboard --api-key "sk-..." --provider openrouter`
- Thiết lập hướng dẫn: `synapseclaw onboard`
- Kiểm tra môi trường: `synapseclaw status` + `synapseclaw doctor`
