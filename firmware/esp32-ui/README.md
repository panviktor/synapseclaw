# SynapseClaw ESP32 UI Firmware

Slint-based graphical UI firmware scaffold for SynapseClaw edge scenarios on ESP32.
...
3. Connect UI state with SynapseClaw edge/runtime messaging
...
- [SynapseClaw Hardware Design](../../docs/hardware/hardware-peripherals-design.md)
