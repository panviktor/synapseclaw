...
<p align="center" dir="rtl">
SynapseClaw הוא תשתית עוזר AI קלת משקל, מוטטבילית וניתנת להרחבה שנבנתה ב-Rust. היא מחברת ספקי LLM שונים (Anthropic, OpenAI, Google, Ollama, וכו') דרך ממשק מאוחד ותומכת בערוצים מרובים (Telegram, Matrix, CLI, וכו').
</p>
...
<p align="center" dir="rtl">
SynapseClaw משתמש בקובץ קונפיגורציה YAML. כברירת מחדל, הוא מחפש `config.yaml`.
</p>
...
<p align="center" dir="rtl">
אם SynapseClaw שימושי עבורך, אנא שקול לקנות לנו קפה:
</p>
