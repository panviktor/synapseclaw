...
Options:
    ...
    --repo OWNER/NAME   Repository (default: panviktor/synapseclaw)
...
def parse_args():
    ...
    parser.add_argument(
        "--repo",
        default="panviktor/synapseclaw",
        help="Repository in OWNER/NAME format (default: panviktor/synapseclaw)",
    )
