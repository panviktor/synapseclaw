"""
Discord bot integration for SynapseClaw.
"""
...
class DiscordBot:
    """
    Discord bot powered by SynapseClaw agent with LangGraph tool calling.
    ...
    def __init__(
        ...
        if not DISCORD_AVAILABLE:
            raise ImportError(
                ...
                "Install with: pip install synapseclaw-tools[discord]"
            )
    ...
    def _setup_events(self):
        @self.client.event
        async def on_ready():
            print(f"SynapseClaw Discord Bot ready: {self.client.user}")
