...
Gói Python đồng hành cho [SynapseClaw](https://github.com/panviktor/synapseclaw) — gọi công cụ dựa trên LangGraph cho thực thi agent LLM nhất quán.
...
| Tính năng | Rust SynapseClaw | synapseclaw-tools |
|---------|---------------|----------------|
...
Dùng **Rust SynapseClaw** cho triển khai biên (edge) trong sản phẩm. Dùng **synapseclaw-tools** khi cần đảm bảo tính nhất quán gọi công cụ hoặc tích hợp hệ sinh thái Python.
