...
SynapseClaw er en letvægts, foranderlig og udvidbar AI-assistent-infrastruktur bygget i Rust. Den forbinder forskellige LLM-udbydere (Anthropic, OpenAI, Google, Ollama osv.) via en samlet grænseflade og understøtter flere kanaler (Telegram, Matrix, CLI osv.).
...
SynapseClaw bruger en YAML-konfigurationsfil. Som standard leder den efter `config.yaml`.
...
Hvis SynapseClaw er nyttigt for dig, overvej venligst at købe os en kaffe:
