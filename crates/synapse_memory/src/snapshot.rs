...
const SNAPSHOT_HEADER: &str = "# 🧠 SynapseClaw Memory Snapshot\n\n\
    > Auto-generated by SynapseClaw. Do not edit manually unless you know what you're doing.\n\
...
mod tests {
    ...
    fn parse_snapshot_basic() {
        let input = r#"# 🧠 SynapseClaw Memory Snapshot

> Auto-generated by SynapseClaw.
...
I am SynapseClaw, a self-preserving AI agent.
...
"#;
    ...
    fn parse_snapshot_empty() {
        let input = "# 🧠 SynapseClaw Memory Snapshot\n\n> Nothing here.\n";
        let entries = parse_snapshot(input);
