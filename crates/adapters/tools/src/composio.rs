...
//
// When enabled, SynapseClaw can execute actions on Gmail, Notion, GitHub, Slack, etc.
...
impl ComposioTool {
    ...
    fn client(&self) -> Client {
        synapse_providers::proxy::build_runtime_proxy_client_with_timeouts("tool.composio", 60, 10)
    }
