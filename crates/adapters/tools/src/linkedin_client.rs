...
use synapse_domain::config::schema::LinkedInImageConfig;
...
impl LinkedInClient {
    ...
    fn client() -> reqwest::Client {
        synapse_providers::proxy::build_runtime_proxy_client_with_timeouts(
            "tool.linkedin",
...
mod tests {
    ...
    fn fallback_card_contains_svg_structure() {
        ...
        assert!(svg.contains("SynapseClaw"));
    }
