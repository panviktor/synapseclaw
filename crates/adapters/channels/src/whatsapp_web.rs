...
//! session_path = "~/.synapseclaw/whatsapp-session.db"  # Required for Web mode
...
/// ```toml
/// [channels_config.whatsapp]
/// session_path = "~/.synapseclaw/whatsapp-session.db"
...
impl WhatsAppWebChannel {
    ...
    #[cfg(feature = "whatsapp-web")]
    pub fn with_tts(mut self, config: synapse_domain::config::schema::TtsConfig) -> Self {
        if config.enabled {
...
impl WhatsAppWebChannel {
    ...
    pub fn with_transcription(
        self,
        _config: synapse_domain::config::schema::TranscriptionConfig,
    ) -> Self {
        self
    }

    pub fn with_tts(self, _config: synapse_domain::config::schema::TtsConfig) -> Self {
        self
    }
}
