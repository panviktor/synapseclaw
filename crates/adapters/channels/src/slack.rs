...
impl SlackChannel {
    ...
    fn http_client(&self) -> reqwest::Client {
        synapse_providers::proxy::build_runtime_proxy_client_with_timeouts("channel.slack", 30, 10)
    }
    ...
    fn slack_media_http_client_no_redirect(&self) -> anyhow::Result<reqwest::Client> {
        let builder = synapse_providers::proxy::apply_runtime_proxy_to_builder(
