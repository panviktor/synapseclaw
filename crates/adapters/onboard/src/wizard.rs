...
#[allow(clippy::too_many_lines)]
fn setup_tunnel() -> Result<synapse_domain::config::schema::TunnelConfig> {
    use synapse_domain::config::schema::{
...
mod tests {
    ...
    fn launchable_channels_include_signal_mattermost_qq_nextcloud_and_feishu() {
        ...
        channels.signal = Some(synapse_domain::config::schema::SignalConfig {
        ...
        channels.mattermost = Some(synapse_domain::config::schema::MattermostConfig {
        ...
        channels.qq = Some(synapse_domain::config::schema::QQConfig {
            app_id: "app-id".into(),
        ...
        channels.qq = None;
        channels.nextcloud_talk = Some(synapse_domain::config::schema::NextcloudTalkConfig {
        ...
        channels.feishu = Some(synapse_domain::config::schema::FeishuConfig {
            app_id: "cli_123".into(),
