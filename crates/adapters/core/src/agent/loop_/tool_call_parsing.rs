//! Tool call parsing — extracts tool invocations from LLM responses.
//!
//! Supports multiple formats: XML tags, JSON, Minimax invoke, Perl-style,
//! GLM shortened, function-call syntax, and native structured tool calls.
