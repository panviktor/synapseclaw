...
//!
//! A standalone robotics toolkit that integrates with SynapseClaw for AI-powered robots.
//!
//! ## Features
//!
...
//! ```text
//! ┌─────────────────────────────────────────────────────────┐
//! │  SynapseClaw AI Brain (or any controller)                  │
...
//!
//! ```rust,ignore
//! use synapseclaw_robot_kit::{RobotConfig, DriveTool, SafetyMonitor, SafeDrive};
//! use std::sync::Arc;
//!
//! #[tokio::main]
//! async fn main() {
...
//! ## Standalone Usage
//!
//! This crate can be used independently of SynapseClaw. It defines its own
//! `Tool` trait that is compatible with SynapseClaw's but doesn't require it.
//!
//! ## Safety
//!
