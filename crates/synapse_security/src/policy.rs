...
pub use synapse_core::domain::config::{AutonomyLevel, ToolOperation};
pub use synapse_core::domain::security_policy::*;
...
mod tests {
    ...
    use synapse_core::domain::config::CommandRiskLevel;
