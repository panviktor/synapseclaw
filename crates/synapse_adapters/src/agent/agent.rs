...
pub struct Agent {
    ...
    config: synapse_core::config::schema::AgentConfig,
    model_name: String,
    temperature: f64,
    workspace_dir: std::path::PathBuf,
    identity_config: synapse_core::config::schema::IdentityConfig,
    skills: Vec<crate::skills::Skill>,
    skills_prompt_mode: synapse_core::config::schema::SkillsPromptInjectionMode,
    auto_save: bool,
    memory_session_id: Option<String>,
    history: Vec<ConversationMessage>,
    classification_config: synapse_core::config::schema::QueryClassificationConfig,
...
pub struct AgentBuilder {
    ...
    config: Option<synapse_core::config::schema::AgentConfig>,
    model_name: Option<String>,
    temperature: Option<f64>,
    workspace_dir: Option<std::path::PathBuf>,
    identity_config: Option<synapse_core::config::schema::IdentityConfig>,
    skills: Option<Vec<crate::skills::Skill>>,
    skills_prompt_mode: Option<synapse_core::config::schema::SkillsPromptInjectionMode>,
    auto_save: Option<bool>,
    memory_session_id: Option<String>,
    classification_config: Option<synapse_core::config::schema::QueryClassificationConfig>,
...
impl AgentBuilder {
    ...
    pub fn config(mut self, config: synapse_core::config::schema::AgentConfig) -> Self {
...
mod tests {
    ...
    async fn turn_without_tools_returns_text() {
        ...
        let memory_cfg = synapse_core::config::schema::MemoryConfig {
            backend: "none".into(),
            ..synapse_core::config::schema::MemoryConfig::default()
        };
    ...
    async fn turn_routes_with_hint_when_query_classification_matches() {
        ...
        let mut agent = Agent::builder()
            ...
            .classification_config(synapse_core::config::schema::QueryClassificationConfig {
                enabled: true,
                rules: vec![synapse_core::config::schema::ClassificationRule {
                    hint: "fast".to_string(),
