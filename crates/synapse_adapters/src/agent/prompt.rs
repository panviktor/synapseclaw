...
pub struct PromptContext<'a> {
    ...
    pub skills: &'a [Skill],
    pub skills_prompt_mode: synapse_core::config::schema::SkillsPromptInjectionMode,
...
mod tests {
    ...
    fn identity_section_with_aieos_includes_workspace_files() {
        ...
        let identity_config = synapse_core::config::schema::IdentityConfig {
            format: "aieos".into(),
            aieos_path: None,
        ...
        let ctx = PromptContext {
            ...
            tools: &tools,
            skills: &[],
            skills_prompt_mode: synapse_core::config::schema::SkillsPromptInjectionMode::Full,
    ...
    fn skills_section_compact_mode_omits_instructions_and_tools() {
        ...
        let ctx = PromptContext {
            ...
            tools: &tools,
            skills: &skills,
            skills_prompt_mode: synapse_core::config::schema::SkillsPromptInjectionMode::Compact,
            identity_config: None,
            dispatcher_instructions: "",
        };
