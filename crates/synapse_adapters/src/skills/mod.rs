...
pub fn handle_command(
    command: synapse_core::commands::SkillCommands,
    config: &synapse_core::config::schema::Config,
) -> Result<()> {
    let workspace_dir = &config.workspace_dir;
    match command {
        synapse_core::commands::SkillCommands::List => {
        ...
        synapse_core::commands::SkillCommands::Audit { source } => {
            let source_path = PathBuf::from(&source);
        ...
        synapse_core::commands::SkillCommands::Install { source } => {
        ...
        synapse_core::commands::SkillCommands::Remove { name } => {
