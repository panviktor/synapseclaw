...
impl ApprovalManager {
    ...
    pub fn record_decision(
        ...
        use synapse_domain::application::services::approval_service;
        use synapse_domain::domain::approval::ApprovalResponse as DomainResponse;
...
impl synapse_domain::ports::approval::ApprovalPort for ApprovalManager {
    ...
    async fn request_approval(
        ...
        tool_name: &str,
        arguments: &str,
    ) -> anyhow::Result<synapse_domain::domain::approval::ApprovalResponse> {
        if self.non_interactive {
            return Ok(synapse_domain::domain::approval::ApprovalResponse::No);
        }
        ...
        Ok(match cli_response {
            ApprovalResponse::Yes => synapse_domain::domain::approval::ApprovalResponse::Yes,
            ApprovalResponse::No => synapse_domain::domain::approval::ApprovalResponse::No,
            ApprovalResponse::Always => synapse_domain::domain::approval::ApprovalResponse::Always,
        })
    }

    fn record_decision(&self, decision: &synapse_domain::domain::approval::ApprovalDecision) {
        let cli_response = match decision.response {
            synapse_domain::domain::approval::ApprovalResponse::Yes => ApprovalResponse::Yes,
            synapse_domain::domain::approval::ApprovalResponse::No => ApprovalResponse::No,
            synapse_domain::domain::approval::ApprovalResponse::Always => ApprovalResponse::Always,
        };
