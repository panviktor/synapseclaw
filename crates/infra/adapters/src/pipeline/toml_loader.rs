...
use std::sync::Arc;
use synapse_domain::domain::pipeline::{PipelineDefinition, PipelineToml};
use synapse_domain::ports::pipeline_store::{PipelineStorePort, ReloadEvent};
...
"#;
    ...
    async fn schema_validation_with_fixture() {
        use crate::pipeline::schema_validator::validate_against_schema;
