...
use std::sync::Arc;
use synapse_domain::domain::memory::{MemoryCategory, MemoryEntry, SessionMemory};
use synapse_domain::ports::conversation_store::ConversationStorePort;
use synapse_domain::ports::memory::MemoryTiersPort;
...
/// Alias for readability — identity function since types are unified.
fn to_domain_entry(e: synapse_domain::domain::memory::MemoryEntry) -> MemoryEntry {
    e
}
