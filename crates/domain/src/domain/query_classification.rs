//! Query classification — domain types and pure matching logic.
//!
//! Classifies user messages against configurable rules to route
//! to the appropriate model hint (e.g. "fast", "reasoning", "code").

use serde::{Deserialize, Serialize};

/// Configuration for the query classification engine.
...
/// Result of a successful classification, exposing match metadata.
