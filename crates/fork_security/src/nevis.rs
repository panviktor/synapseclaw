//! Nevis IAM authentication provider for SynapseClaw.
//!
...
//! roles to SynapseClaw tool permissions via [`super::iam_policy::IamPolicy`].
...
mod tests {
    ...
    fn nevis_identity_serde_roundtrip() {
        ...
        assert_eq!(parsed.user_id, "synapseclaw_user");
