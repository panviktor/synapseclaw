...
SynapseClaw är en lättvikts, föränderlig och utökningsbar AI-assistent-infrastruktur byggd i Rust. Den ansluter olika LLM-leverantörer (Anthropic, OpenAI, Google, Ollama, etc.) via ett enhetligt gränssnitt och stöder flera kanaler (Telegram, Matrix, CLI, etc.).
...
SynapseClaw använder en YAML-konfigurationsfil. Som standard letar den efter `config.yaml`.
...
Om SynapseClaw är användbart för dig, vänligen överväg att köpa en kaffe till oss:
