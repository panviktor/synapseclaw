...
SynapseClaw er en lettvektig, foranderlig og utvidbar AI-assistent-infrastruktur bygget i Rust. Den kobler sammen ulike LLM-leverandører (Anthropic, OpenAI, Google, Ollama osv.) via et samlet grensesnitt og støtter flere kanaler (Telegram, Matrix, CLI osv.).
...
SynapseClaw bruker en YAML-konfigurasjonsfil. Som standard ser den etter `config.yaml`.
...
Hvis SynapseClaw er nyttig for deg, vennligst vurder å kjøpe oss en kaffe:
